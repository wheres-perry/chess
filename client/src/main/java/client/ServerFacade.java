...
public class ServerFacade {
    ...
    // Map<String, Object> is a can be used to store key-value pairs, helpful for JSON responses
    // object keeps it generic so it can be nested or any obejct.
    ...
    public Map<String, Object> joinGame(String authToken, int gameID, String playerColor) throws Exception {
        // Stub implementation
        return null;
    }
}