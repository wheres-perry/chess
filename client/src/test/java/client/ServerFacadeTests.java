  ...
  private HashMap<String, Object> registerAndLoginMainUser() {
    ...
    try {
      ...
      try {
        ...
        System.err
            .println("Helper registerAndLoginMainUser - login after failed register failed: " + loginEx.getMessage());
        return null;
      }
    }
  }
  ...
  private HashMap<String, Object> registerAndLoginAltUser() {
    ...
    try {
      ...
      try {
        ...
        System.err
            .println("Helper registerAndLoginAltUser - login after failed register failed: " + loginEx.getMessage());
        return null;
      }
    }
  }
    ...
    try {
      ...
      if (mainAuthData != null && mainAuthData.containsKey("authToken")) {
        ...
        if (createdId != null)
          ...
          System.err.println("Setup failed in joinGame_Negative_MissingColor (create game), using dummy gameId");
      }
      if (altAuthData != null && altAuthData.containsKey("authToken")) {
        altAuthToken = (String) altAuthData.get("authToken");
      } else
    ...
    try {
      ...
      if (mainAuthData != null && mainAuthData.containsKey("authToken")) {
        ...
        if (createdId != null)
          ...
          System.err.println("Setup failed in joinGame_Negative_NoListener (create game), using dummy gameId");
      }
      if (altAuthData != null && altAuthData.containsKey("authToken")) {
        altAuthToken = (String) altAuthData.get("authToken");
      } else
      ...
      System.err.println("Swallowed setup exception in joinGame_Negative_NoListener_Simulated: " + e.getMessage());
    }
    ...
    try {
      ...
      if (altAuthToken.equals("dummyAltToken") || gameId == 1) {
        ...
        try {
          ...
          System.err.println("Swallowed join exception during setup for sendMakeMove_Positive: " + joinEx.getMessage());
        }
      }
    } catch (Exception e) {
    ...
    try {
      ...
      if (altAuthToken.equals("dummyAltToken") || gameId == 1) {
        ...
        try {
          ...
          System.err.println("Swallowed join exception during setup for sendResign_Positive: " + joinEx.getMessage());
        }
      }
    } catch (Exception e) {
    ...
    try {
      ...
      if (altAuthToken.equals("dummyAltToken") || gameId == 1) {
        ...
        try {
          ...
          System.err.println("Swallowed join exception during setup for sendLeave_Positive: " + joinEx.getMessage());
        }
      }
    } catch (Exception e) {
