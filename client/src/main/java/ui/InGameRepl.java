...
public class InGameRepl {
  ...
  public boolean run() {
    ...
    while (inGame) {
      System.out.print(EscapeSequences.RESET_BG_COLOR + EscapeSequences.RESET_TEXT_COLOR + "[" + client.getCurrentUser()
      ...
      try {
        switch (command) {
          ...
          case "quit": // Allow quit from in-game
            ...
            return true;
          default:
            System.out.println(EscapeSequences.SET_TEXT_COLOR_RED + "Unknown command in game. Type 'help' for options."
  ...
  private void displayHelp() {
    ...
    System.out.println(EscapeSequences.SET_TEXT_COLOR_YELLOW + "  highlight <SQUARE>"
        + EscapeSequences.SET_TEXT_COLOR_WHITE + " - Show legal moves for piece at SQUARE (e.g., highlight e2)");
